...
<head>
	...
	<script type="text/javascript">
        ...
        function showItemsDialog(itemId) {
            showDialogByUrl(ctx + '/erp/erpProductionOrder/childView?id=' + (itemId || '') + '&orderId=' + $("#id").val(), '生产订单', window);
        }
	</script>
</head>
<body>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<script type="text/template" id="erpProductionOrderTpl">//<!--
						<tr id="erpProductionOrderList{{idx}}" onclick="showItemsDialog('{{row.id}}')">
							<td class="hide">
