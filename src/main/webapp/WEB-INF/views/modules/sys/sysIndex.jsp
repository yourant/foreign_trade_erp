...
<head>
	...
	<style type="text/css">
		...
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:40px;color:#ffffff;padding-left:33px;}
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner topbg">
				<div class="brand top-logo"><span id="productName">${fns:getConfig('productName')}</span></div>
				<ul id="userControl" class="nav pull-right">
					...
					<li><a id="logout_id" href="${ctx}/logout" title="退出登录">退出</a></li>
					<li>&nbsp;</li>
				</ul>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2018-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://www.qdqtrj.com" target="_blank">青岛前途软件</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
		...
		function wSizeWidth(){
			if (!$("#openClose").is(":hidden")){
				...
				$("#right").width($("#content").width()- leftWidth - $("#openClose").width() -17);
			}else{
				$("#right").width("100%");
			}
