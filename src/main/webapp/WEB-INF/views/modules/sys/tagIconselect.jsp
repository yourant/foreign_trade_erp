...
<head>
	...
	<script type="text/javascript">
        $(document).ready(function(){
            // 兼容阿里图标库
            $("#icons2 li").click(function () {
                $("#icons2 li").removeClass("active");
                $("#icons2 li i").removeClass("icon-white");
                $(this).addClass("active");
                $(this).children("i").addClass("icon-white");
                var c = $(this).find('.fontclass').text();
                console.log(c)
                $("#icon").val(c);
            });
            $("#icons2 li").each(function () {
                if ($(this).text() == "${value}") {
                    $(this).click();
                }
            });
            $("#icons2 li").dblclick(function () {
...
<div id="icons2">
	...
	<ul class="icon_lists clear">
		...
		<li>
			<i class="icon iconfont icon-sanbaoshouli"></i>
			<div class="name">三包受理</div>
			<div class="fontclass">.icon-sanbaoshouli</div>
		</li>

		<li>
			<i class="icon iconfont icon-fadongji"></i>
			<div class="name">发动机</div>
			<div class="fontclass">.icon-fadongji</div>
		</li>

		<li>
			<i class="icon iconfont icon-peijian"></i>
			<div class="name">配件</div>
			<div class="fontclass">.icon-peijian</div>
		</li>

		<li>
			<i class="icon iconfont icon-peijian1"></i>
			<div class="name">配件</div>
		...
		<li>
			<i class="icon iconfont icon-icon-kehugenzong"></i>
			<div class="name">icon-客户跟踪</div>
			<div class="fontclass">.icon-icon-kehugenzong</div>
		</li>
		...
		<li>
			<i class="icon iconfont icon-wodetonggao"></i>
			<div class="name">我的通告</div>
			<div class="fontclass">.icon-wodetonggao</div>
		</li>

		<li>
			<i class="icon iconfont icon-chexing"></i>
			<div class="name">车型</div>
			<div class="fontclass">.icon-chexing</div>
		</li>
