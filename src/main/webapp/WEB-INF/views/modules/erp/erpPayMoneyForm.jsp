...
<body>
	...
	<form:form id="inputForm" modelAttribute="erpPayMoney" action="${ctx}/erp/erpPayMoney/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="erpPayType.id" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="payableMoney" htmlEscape="false" class="input-xlarge  number"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">实付款：</label>
			<div class="controls">
				<form:input path="comeMoney" htmlEscape="false" class="input-xlarge  number"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="scale" htmlEscape="false" type="number" step="1" class="input-xlarge  scale"/>
			</div>
		</div>
		<div class="control-group">
