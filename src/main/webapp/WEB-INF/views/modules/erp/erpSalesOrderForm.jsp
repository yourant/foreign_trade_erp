...
<form:form id="inputForm" modelAttribute="erpSalesOrder" action="${ctx}/erp/erpSalesOrder/save" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:input path="erpCustomer.id" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:select path="enmuTradingType" class="input-xlarge ">
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:input path="piNo" htmlEscape="false" maxlength="25" class="input-xlarge "/>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">简要生产计划：</label>
		<div class="controls">
			<form:textarea path="productionPlain" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge "/>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			...
			<script type="text/template" id="erpProductionOrderTpl">//<!--
						<tr id="erpProductionOrderList{{idx}}">
							...
							<td>
								<textarea id="erpProductionOrderList{{idx}}_content" name="erpProductionOrderList[{{idx}}].content" rows="4" class="input-small ">{{row.content}}</textarea>
							</td>
							<td>
