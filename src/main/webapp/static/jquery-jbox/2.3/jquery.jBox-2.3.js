...
(function (a) {
	...
	a.jBox = function (b, c) {
		...
		if(c.opener){
            a.jBox.openerWindows.push(c.opener)
        }
	...
	a.jBox.getOpener = function(){
		return a.jBox.openerWindows[a.jBox.openerWindows.length-1];
	};
...
jBoxConfig.languageDefaults = {
    ...
    ok: '关闭', /* $.jBox.prompt() 系列方法的“关闭”按钮文字 */
