 ...
 *
 */
package com.fy.erp.modules.act.utils;

import com.fasterxml.jackson.annotation.JsonBackReference;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fy.erp.common.annotation.FieldName;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
    ...
    public static final String[] PD_SALES_ORDER = new String[]{"sales_order_process", "erp_sales_order"};
    public static final String[] PD_REPAIR_ORDER = new String[]{"repair_order_process", "erp_repair_order"};
    public static final String[] PD_PARTS_ORDER = new String[]{"parts_order_process", "erp_parts_order"};
