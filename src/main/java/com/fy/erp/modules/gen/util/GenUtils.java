...
//		}
    ...
    public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile) {
        ...
        if (isReplaceFile) {
            ...
            if (file.exists()) {
                try {
                    String code = org.apache.commons.io.FileUtils.readFileToString(file, "UTF-8");
                    String customCode = "";
                    String genCode = "";
                    customCode = code.substring(code.indexOf("========================================================================================"));
                    genCode = content.substring(0, content.indexOf("========================================================================================"));
//                    if (fileName.contains(".Dao.xml")) { // 注释语句不太一样
//                        customCode = code.substring(code.indexOf("<!--========================================================================================-->"));
//                        genCode = content.substring(0, content.indexOf("<!--========================================================================================-->"));
//                    }else{
//                        customCode = code.substring(code.indexOf("========================================================================================"));
...
//                    }
                    ...
                    if (FileUtils.createFile(fileName)) {
                        org.apache.commons.io.FileUtils.writeStringToFile(file, newCode, "UTF-8", true);
