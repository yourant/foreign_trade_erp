...
import com.fy.erp.modules.cms.dao.CategoryDao;
...
import com.fy.erp.modules.cms.dao.ArticleDao;
...
//		return dao.find(page, dc);
	...
	public int save(Article article) {
		...
		if (StringUtils.isBlank(article.getId())){
			...
			dao.insert(article);
			return 	articleDataDao.insert(articleData);
		}else{
			article.preUpdate();
			articleData = article.getArticleData();
			articleData.setId(article.getId());
			dao.update(article);
		return 	articleDataDao.update(article.getArticleData());
		}
	}
