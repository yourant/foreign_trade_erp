 ...
 *
 */
package com.fy.erp.modules.oa.service;
...
import com.fy.erp.modules.oa.entity.OaNotify;
import com.fy.erp.modules.oa.entity.OaNotifyRecord;
import com.fy.erp.modules.oa.dao.OaNotifyDao;
import com.fy.erp.modules.oa.dao.OaNotifyRecordDao;
...
public class OaNotifyService extends CrudService<OaNotifyDao, OaNotify> {
    ...
    public int save(OaNotify oaNotify) {
        super.save(oaNotify);
        ...
        if (oaNotify.getOaNotifyRecordList().size() > 0) {
            i = oaNotifyRecordDao.insertAll(oaNotify.getOaNotifyRecordList());
        }
        return i;
    }
